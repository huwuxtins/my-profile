package com.my_profile.notification_service.config;

import com.my_profile.notification_service.security.Auth0ClientCredentialsGrantRequestEntityConverter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> {
                    authorize
                            .requestMatchers("/", "/images/**", "/api/v1/notification-swagger/**").permitAll()
