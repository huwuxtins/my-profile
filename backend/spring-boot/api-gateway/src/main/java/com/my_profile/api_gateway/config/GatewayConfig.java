...
public class GatewayConfig {
    ...
    public RouteLocator routes(RouteLocatorBuilder builder){
        ...
        .route("content-management-swagger", r -> r.path("/api/v1/content-management-swagger/**").uri("lb://content-managementp-service"))
        ...
        .route("content-management-service", r -> r.path("/api/v1/content-management-service/**").uri("lb://content-managementp-service"))
