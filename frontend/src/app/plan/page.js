    ...
    return <div>
        <div className="lg:flex lg:h-full lg:flex-col px-4 py-16 sm:px-2 sm:py-24">
            ...
            <div className="shadow ring-1 ring-black ring-opacity-5 lg:flex lg:flex-auto lg:flex-col">
                ...
                <div className="flex bg-gray-200 text-xs leading-6 text-gray-700 lg:flex-auto  grid-cols-7 grid-rows-6 lg:grid lg:grid-cols-7 lg:grid-rows-6 lg:gap-px">
                    <div className="hidden w-full grid">
