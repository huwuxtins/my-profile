...
function BlogPage({ children }) {
    ...
    return (
        <div className="bg-gray-100 dark:bg-gray-800 mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                ...
                <div className="sm:col-span-2">
                    ...
                    <div className="mt-2.5">
                        <textarea
                            ...
                            id="message"
                            rows={4}
                            className="block w-full rounded-md border-0 px-3.5 py-2 bg-gray-100 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            defaultValue={''}
                        />
                    </div>
                </div>
